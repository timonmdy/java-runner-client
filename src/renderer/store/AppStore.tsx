...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <AppContext.Provider value={{ state, activeProfile, setActiveProfile, saveProfile, deleteProfile, createProfile, reorderProfiles, startProcess, stopProcess, sendInput, clearConsole, saveSettings, isRunning }}>
      {children}
    </AppContext.Provider>
  )
}
