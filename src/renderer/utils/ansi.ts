...
const COLORS: Record<number, string> = {
  ...
  34: '#60a5fa', 35: '#c084fc', 36: '#34d399', 37: '#e8eaf2',
  90: '#6b7094', 91: '#fca5a5', 92: '#86efac', 93: '#fde68a',
  94: '#93c5fd', 95: '#d8b4fe', 96: '#6ee7b7', 97: '#ffffff',
};

const BG_COLORS: Record<number, string> = {
  40: '#4a4a4a', 41: '#7f1d1d', 42: '#14532d', 43: '#78350f',
  44: '#1e3a5f', 45: '#581c87', 46: '#134e4a', 47: '#374151',
  100: '#374151', 101: '#991b1b', 102: '#166534', 103: '#92400e',
  104: '#1d4ed8', 105: '#7e22ce', 106: '#0f766e', 107: '#6b7280',
};
...
function applyCodes(codes: number[], state: SgrState): SgrState {
  ...
  while (i < codes.length) {
    ...
    else if (c === 49) { s.bgColor = undefined; }
    else if (COLORS[c]) { s.color = COLORS[c]; }
    else if (BG_COLORS[c]) { s.bgColor = BG_COLORS[c]; }
