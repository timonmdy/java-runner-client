export type {
  Profile, AppSettings, ConsoleLine, ProcessState,
  SystemProperty, JvmArgument, ProgramArgument,
  ProcessLogEntry, JavaProcessInfo,
} from '../../main/shared/types'

export type MainTab = 'console' | 'config' | 'profile'
