...
const ENGLISH_STRINGS = {
  ...
  'dev.api.restDisabled': 'REST API is disabled in Settings',
  'dev.api.selectRoute': 'Select a route to inspect and call it',
  'dev.api.send': 'Send',
  'dev.api.copyUrl': 'Copy URL',
  'dev.api.pathParams': 'Path Parameters',
  'dev.api.requestBody': 'Request Body',
  'dev.api.formMode': 'Form',
  'dev.api.rawJson': 'Raw JSON',
  'dev.api.required': 'required',
  'dev.api.optional': 'optional',
  'dev.api.response': 'Response',
  'dev.api.waiting': 'Waiting for response...',
  'dev.api.pressSend': 'Press Send to call the API',
  'dev.api.copyResponse': 'Copy response',
  'dev.api.viewFormatted': 'View formatted',
  'dev.api.editRaw': 'Edit raw',
  'dev.api.switchToRaw': 'Switch to Raw JSON',
  'dev.api.switchToForm': 'Switch to Form',
  'dev.storage': 'Storage',
  ...
  'dev.themeEditor': 'Theme Editor',
  'dev.themeEditorHint':
    'Edit colors live — changes are previewed instantly but not saved to disk.',
  'dev.resetColor': 'Reset',
  'dev.resetAll': 'Reset All',
  'dev.colorCategories.base': 'Base',
  'dev.colorCategories.surface': 'Surface',
  'dev.colorCategories.text': 'Text',
  'dev.colorCategories.console': 'Console',
  'dev.colorCategories.accent': 'Accent',
  'dev.livePreview': 'Live Preview',
  'dev.exportTheme': 'Export',
  'dev.importTheme': 'Import',
  'dev.copiedToClipboard': 'Copied to clipboard',
  'dev.invalidJson': 'Invalid JSON in clipboard',
  'dev.allKeysTranslated': 'All {count} keys translated',
  'dev.missingKeyCount': '{count} missing key(s)',
  'dev.refreshLanguage': 'Refresh',
  'dev.lastRefreshed': 'Last refreshed: {time}',
