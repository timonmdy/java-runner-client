  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Open Utilities → Process Scanner → Scan. Java processes are highlighted. Click Kill next to the stuck one, or use "Kill All Java".',
      },
    ],
  },
  {
